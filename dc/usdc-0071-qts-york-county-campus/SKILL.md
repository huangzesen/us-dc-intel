# USDC-0071 — QTS York County campus

## 一句话
State announcement confirms QTS selected York County for a campus

## 位置
- City: None
- County: York County
- State: SC
- 地址/地块: Near Hands Mill Highway and Campbell Road, unincorporated York County
