# USDC-0008 — Spalding County data-center campus

## 一句话
Applications were formally withdrawn according to Spalding County's official public notice so the proposal could later be considered by the full Board with more public participation

## 位置
- City: None
- County: Spalding County
- State: GA
- 地址/地块: Not disclosed in the official withdrawal notice reviewed
