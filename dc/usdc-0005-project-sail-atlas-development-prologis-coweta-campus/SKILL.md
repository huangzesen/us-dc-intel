# USDC-0005 — Project Sail / Atlas Development–Prologis Coweta campus

## 一句话
Large proposed campus with DRI/utility-planning and developer-site evidence, but no verified groundbreaking, building permit, certificate of occupancy, energized load, or tenant identity was located

## 位置
- City: near Newnan
- County: Coweta County
- State: GA
- 地址/地块: Exact parcel not disclosed in reviewed public records
