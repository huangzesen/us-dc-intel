# USDC-0076 — Hixson AI data center

## 一句话
Proposed/under development in press coverage; McMinnville’s public engagement page records a data-center pause/study

## 位置
- City: McMinnville
- County: Warren County
- State: TN
- 地址/地块: Exact parcel and applicant identity not disclosed in the accessible government record
