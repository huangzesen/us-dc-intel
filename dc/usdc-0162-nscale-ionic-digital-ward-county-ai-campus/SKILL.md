# USDC-0162 — Nscale/Ionic Digital Ward County AI campus

## 一句话
Candidate is supported by company/SEC material and a Texas Comptroller registry row under the Cedarvale/Barstow-Pyote name; that registry's exemption ended 2026-03-15

## 位置
- City: Pyote / Barstow area
- County: Ward
- State: Texas
- 地址/地块: 
