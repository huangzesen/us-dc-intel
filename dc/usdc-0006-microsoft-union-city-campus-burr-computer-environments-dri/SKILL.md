# USDC-0006 — Microsoft Union City campus / Burr Computer Environments DRI

## 一句话
Georgia DCA record supports a Microsoft-related DRI approval/reporting trail for a proposed three-phase campus

## 位置
- City: Union City
- County: Fulton County
- State: GA
- 地址/地块: North side of South Fulton Parkway; exact parcel not published in reviewed records
