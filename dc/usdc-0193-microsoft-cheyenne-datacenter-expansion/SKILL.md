# USDC-0193 — Microsoft Cheyenne datacenter expansion

## 一句话
Microsoft announced an intent to purchase/develop additional Cheyenne acreage and later said it submitted applications for expansion areas

## 位置
- City: Cheyenne
- County: Laramie
- State: WY
- 地址/地块: Microsoft describes two 3,200-acre expansion parcels near Wapiti Trail/S Greeley Highway; exact parcel IDs not independently validated
...
- master_id: USDC-0193
- phase3 stable_id: US-WY-MICROSOFT-CHEYENNE-2026
