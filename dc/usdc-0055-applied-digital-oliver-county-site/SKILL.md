# USDC-0055 — Applied Digital Oliver County site

## 一句话
A local television report says Applied Digital was pursuing a third North Dakota data center and that Oliver County commissioners signed a road-use and operations agreement on 2026-07-10

## 位置
- City: Hanover area
- County: Oliver County
- State: ND
- 地址/地块: Site south of Hanover; exact parcel and capacity not published in reviewed records
...
- master_id: USDC-0055
- phase3 stable_id: ND-HANOVER-APPLIED-OLIVER
