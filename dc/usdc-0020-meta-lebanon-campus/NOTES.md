...
- 修正（fixer 2026-08-11）：data.json history[0]（status_as_of_cutoff）的 old_value 由 null 修正为 baseline 实际记录的 `no status`（与 SKILL.md 一句话及本文件 2026-07-16 baseline 段一致），使 history 与 NOTES.md 同步。
