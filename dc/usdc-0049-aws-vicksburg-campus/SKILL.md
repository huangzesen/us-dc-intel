# USDC-0049 — AWS Vicksburg campus

## 一句话
State-announced $3 billion campus with construction expected in 2026; no physical start, building permit, CO, energized service, or commissioning record was located

## 位置
- City: Vicksburg
- County: Warren County
- State: MS
- 地址/地块: Exact parcel not disclosed
