# USDC-0004 — QTS Fayetteville / Project Excalibur

## 一句话
Government notices confirm active construction-related work and county water-accounting activity

## 位置
- City: Fayetteville
- County: Fayette County
- State: GA
- 地址/地块: QTS driveway on Tyrone Road; individual parcels not published in the reviewed pages
