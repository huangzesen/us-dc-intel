...
- 修复 pass（2026-08-11）：将 Northern Journal 报道 URL（arctic-bitcoin-hilcorp-tech-firm-aim-to-test-north-slope-data-center）补入 data.json sources.source_urls，用于支撑 owner 字段中 Hilcorp 现有发电设备所有方、Duck Island/Endicott 场地方的主张；该 URL 此前仅在 NOTES.md 引用、未列入 data.json。已验证该 URL 可访问（HTTP 200）且内容直接支撑该主张。来源：https://www.northernjournal.com/arctic-bitcoin-hilcorp-tech-firm-aim-to-test-north-slope-data-center/
