# USDC-0154 — Galaxy Helios campus / CoreWeave AI site

## 一句话
Phase I is reported complete by Galaxy and Phase II has TDLR registrations; a PUC self-generator registration is approved, while the full local permit/water record is not assembled

## 位置
- City: Afton / Dickens area
- County: Dickens
- State: Texas
- 地址/地块: 
