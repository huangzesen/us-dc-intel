# USDC-0040 — Meta Rosemount data center

## 一句话
Rosemount's official progress page describes Meta's UMore Park data center as approved/under construction with a 2026 completion target and sustainability goals

## 位置
- City: Rosemount
- County: Dakota County
- State: MN
- 地址/地块: UMore Park; exact building/parcel not published on reviewed city progress page
...
- master_id: USDC-0040
- phase3 stable_id: MN-ROSEMOUNT-META
