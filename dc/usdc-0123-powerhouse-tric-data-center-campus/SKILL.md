# USDC-0123 — PowerHouse TRIC data-center campus

## 一句话
State-published material describes a PowerHouse TRIC shell campus, while the reviewed Storey County and utility search surfaces did not yield a project-specific permit, construction record, service da

## 位置
- City: Sparks area
- County: Storey
- State: NV
- 地址/地块: Tahoe Reno Industrial Center; parcel not independently validated
...
- master_id: USDC-0123
- phase3 stable_id: US-NV-POWERHOUSE-TRIC-2024
