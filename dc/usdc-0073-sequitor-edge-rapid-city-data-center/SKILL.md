# USDC-0073 — Sequitor Edge Rapid City data center

## 一句话
Local reporting describes Sequitor Edge's Rapid City proposal as moving forward, with public capacity reports of 2 MW and 15 MW and a 2027 completion expectation

## 位置
- City: Rapid City
- County: Pennington County
- State: SD
- 地址/地块: Black Hills Industrial Center; exact parcel/address not published in reviewed reports
...
- master_id: USDC-0073
- phase3 stable_id: SD-RAPID-CITY-SEQUITOR
