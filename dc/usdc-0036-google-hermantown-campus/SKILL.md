# USDC-0036 — Google Hermantown campus

## 一句话
Google is publicly identified as the proposed developer/operator

## 位置
- City: Hermantown
- County: St. Louis County
- State: MN
- 地址/地块: Hermantown / Arrowhead Station area; exact parcel not published in reviewed records
...
- master_id: USDC-0036
- phase3 stable_id: MN-HERMANTOWN-GOOGLE
