# USDC-0044 — Project Spade

## 一句话
Missouri DED and Google's current location material identify a planned/in-development data center in Montgomery County/New Florence

## 位置
- City: New Florence area
- County: Montgomery County
- State: MO
- 地址/地块: New Florence/Montgomery County region; exact parcel not published in reviewed records
...
- master_id: USDC-0044
- phase3 stable_id: MO-NEW-FLORENCE-GOOGLE-SPADE
