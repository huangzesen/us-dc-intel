# USDC-0119 — Project Jupiter / Stargate Doña Ana County

## 一句话
Project Jupiter remains a proposed/under-review project with unresolved scope and status

## 位置
- City: Santa Teresa
- County: Doña Ana
- State: NM
- 地址/地块: Multiple reported campus/microgrid locations; exact parcel crosswalk not independently validated
...
- master_id: USDC-0119
- phase3 stable_id: US-NM-STARGATE-JUPITER-SANTA-TERESA-2025
