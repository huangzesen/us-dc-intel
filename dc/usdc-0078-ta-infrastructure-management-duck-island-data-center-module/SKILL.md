# USDC-0078 — TA Infrastructure Management Duck Island data-center module

## 一句话
Pilot land-use application; later installation, operation, and construction completion were not verified

## 位置
- City: None
- County: North Slope Borough
- State: AK
- 地址/地块: Duck Island Unit / Satellite Drilling Island
...
- master_id: USDC-0078
- phase3 stable_id: US-AK-TAINFRA-DUCK-ISLAND-PILOT-2024
