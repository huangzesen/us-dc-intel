# USDC-0038 — Scannell Technology Park

## 一句话
Scannell's project has an official comprehensive-plan history and was included in Monticello's data-center review

## 位置
- City: Monticello
- County: Wright County
- State: MN
- 地址/地块: Approximately 106 acres between Otter Creek Crossing Industrial Park, 90th Street NW, and Bertram Chain of Lakes Regional Park; exact parcel not published in reviewed record
...
- master_id: USDC-0038
- phase3 stable_id: MN-MONTICELLO-SCANNELL
