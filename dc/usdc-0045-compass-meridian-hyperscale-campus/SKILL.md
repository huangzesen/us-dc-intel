# USDC-0045 — Compass Meridian hyperscale campus

## 一句话
State announcement and Mississippi PSC special-contract approval support development; Compass’s current market page says the Meridian campus broke ground in 2025

## 位置
- City: Meridian
- County: Lauderdale County
- State: MS
- 地址/地块: Exact parcel not disclosed in the accessible record
