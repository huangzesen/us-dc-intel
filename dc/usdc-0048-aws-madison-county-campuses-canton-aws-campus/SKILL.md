# USDC-0048 — AWS Madison County campuses / Canton AWS campus

## 一句话
Multiple-campus construction/phased development is confirmed by state announcements; the 2026 state announcement adds an $11 billion Madison County expansion

## 位置
- City: Canton area
- County: Madison County
- State: MS
- 地址/地块: Two Madison County industrial parks/MegaSite; building-level parcels not disclosed
