# USDC-0207 — Google Putnam County high-impact data center

## 一句话
State announcement says Google purchased land and received initial approval for a multibillion-dollar High Impact Data Center Project, but the project remained in early stages

## 位置
- City: near Buffalo
- County: Putnam County
- State: WV
- 地址/地块: Exact parcel was not disclosed in the official announcement.
