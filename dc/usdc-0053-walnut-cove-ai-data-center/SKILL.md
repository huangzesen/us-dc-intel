# USDC-0053 — Walnut Cove AI data center

## 一句话
Press reports conflict: one reported a January 2026 rezoning approval and another reported that a key zoning approval was voided and the process restarted in April

## 位置
- City: Walnut Cove
- County: Stokes County
- State: NC
- 地址/地块: Approximately 1,800 acres reported; exact parcel/applicant not established in official accessible records
