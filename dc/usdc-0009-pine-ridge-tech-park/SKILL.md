# USDC-0009 — Pine Ridge Tech Park

## 一句话
Twiggs County published an application and public-hearing procedure for the proposed project

## 位置
- City: None
- County: Twiggs County
- State: GA
- 地址/地块: Pine Ridge Technology Park; exact parcel not disclosed in reviewed official notice
