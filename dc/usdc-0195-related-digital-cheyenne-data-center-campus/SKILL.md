# USDC-0195 — Related Digital Cheyenne data-center campus

## 一句话
Wyoming Business Council material officially describes Related Digital’s campus as under construction, certified for the state data-center sales-tax exemption, and planned for up to 302 MW with CoreWe

## 位置
- City: Cheyenne
- County: Laramie
- State: WY
- 地址/地块: Cheyenne Business Parkway; exact parcel/permit not independently matched
...
- master_id: USDC-0195
- phase3 stable_id: US-WY-RELATED-COREWEAVE-CHEYENNE-2025
