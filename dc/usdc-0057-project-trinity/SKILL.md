# USDC-0057 — Project Trinity

## 一句话
A February 2025 specialist report says Williams County commissioners gave Teton Digital permission to apply for a conditional-use permit for a planned 100 MW campus with a 30 MW first phase

## 位置
- City: Tioga area
- County: Williams County
- State: ND
- 地址/地块: Dry Fork Township/Tioga area; approximately 25 acres in reviewed project reporting
...
- master_id: USDC-0057
- phase3 stable_id: ND-TIOGA-TETON-TRINITY
